...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" "), (_vm.fileList.length < _vm.fileNumLimit) ? _c('li', {
    ref: "addThumb",
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.buttonText))])]), _vm._v(" "), _c('ul', {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function mounted() {
        ...
        this.initUploader();
        var i = void 0;
        var initImgUploaderSize = function initImgUploaderSize() {
            var element = _this.$refs.root.querySelector('.webuploader-element-invisible');

            if (element !== null) {
                clearTimeout(i);
                element.parentNode.style.width = _this.thumbnailWidth + 'px';
                element.parentNode.style.height = _this.thumbnailHeight + 'px';
            } else {
        ...
        i = setTimeout(function () {
            if (_this.type === 'img' && typeof _this.$refs.root !== 'undefined') {
                initImgUploaderSize();
            }
        });
...
Component.options.__file = "/Users/rubyisapm/teamshare/adc-packages/ct-adc-uploader/src/component/index.vue"
