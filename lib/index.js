        ...
        this.uploader.on('beforeFileQueued', function (file) {
            ...
            var i = setTimeout(function () {
                if (this.type === 'img') {
                    ...
                    var widthOK = this.acceptWidth === 0 || width === this.acceptWidth;
                    var heightOK = this.acceptHeight === 0 || height === this.acceptHeight;
                    if (!widthOK || !heightOK) {
                        this.$emit('runtime-error', {
                            code: 'F_Q_EXCEED_WH_LIMIT',
                            msg: __WEBPACK_IMPORTED_MODULE_0__errors__["a" /* default */]['F_Q_EXCEED_WH_LIMIT']
                        });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return [(thumb.valid !== false) ? _c('li', {
      key: index,
      style: ({
